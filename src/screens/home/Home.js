    ...
    render() {
        ...
        return (
            <div>
                ...
                {classes.upcomingMoviesHeading && classes.upcomingMoviesHeading.length>0 && classes.upcomingMoviesHeading && (
                    <div className={classes.upcomingMoviesHeading}>
                        <span>Upcoming Movies</span>
                    </div>
                )}

                { classes.upcomingMoviesHeading.length <= 0  && (
                    <div className={classes.upcomingMoviesHeading}>
                ...
                <GridList cellHeight={250}  cols={6} className={classes.gridListUpcomingMovies} >
                    {this.state.upcomingMovies && this.state.upcomingMovies.length>0 &&  this.state.upcomingMovies.map(movie => (
                ...
                <div className="flex-container">
                    <div className="left">
                        <GridList cellHeight={350} cols={4} className={classes.gridListMain}>
                            {this.state.releasedMovies && this.state.releasedMovies.length>0 &&  this.state.releasedMovies.map(movie => (
                        ...
                        <Card>
                            <CardContent>
                                ...
                                <FormControl className={classes.formControl}>
                                    ...
                                    >
                                        {this.state.genresList && this.state.genresList.length>0 &&  this.state.genresList.map(genre => (
                                ...
                                <FormControl className={classes.formControl}>
                                    ...
                                    >
                                        {this.state.artistsList && this.state.artistsList.length>0 && this.state.artistsList.map(artist => (
